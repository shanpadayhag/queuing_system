...
Window {
    ...
    function chooseProgram() {
        if (programText.text === "Computer Science") {
            programText.text = "Entertainment and Multimedia Computing"
        } else if (programText.text === "Entertainment and Multimedia Computing") {
            programText.text = "Information System"
        } else if (programText.text === "Information System") {
            programText.text = "Information Technology"
        } else if ( programText.text === "Information Technology") {
             programText.text = "Computer Science"
        }  else {
            programText.text = "Entertainment and Multimedia Computing"
        }
    }
    ...
    function create_account() {
        if (
            ...
            if (programText.text === "") {
                programText.text = "Enter your program" 
                programText.color = "#EF534F"
            }
            if (nameText.text === "") {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            CustomTextField {
                ...
                placeholderText: "Click the button for program"
                font.pixelSize: 13
                readOnly: true
                onActiveFocusChanged: {
                    nameText.color = "#FFFFFF"
            ...
            CustomButton {
                id: programBtn
                height: 40
                anchors.left: programText.right
                anchors.leftMargin: 5
                anchors.right: idText.right
                anchors.verticalCenter: programText.verticalCenter
                text: "Program"
                font.pixelSize: 13
                font.bold: true
                onClicked: chooseProgram()
            }
            
            CustomTextField {
                id: passwordText
                width: 355
                anchors.top: programBtn.bottom
                anchors.topMargin: 20
                anchors.horizontalCenter: parent.horizontalCenter
