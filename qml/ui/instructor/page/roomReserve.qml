...
Item {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        InstructorRoomReservation.reserveRoom("FH101", fh101PurposeText.text)
                        InstructorRoomReservation.checkAvailability()
                        InstructorRoomReservation.checkRecent()
                    }
                }
            }
        }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        InstructorRoomReservation.reserveRoom("FH201", fh201PurposeText.text)
                        InstructorRoomReservation.checkAvailability()
                        InstructorRoomReservation.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        InstructorRoomReservation.reserveRoom("FH301", fh301PurposeText.text)
                        InstructorRoomReservation.checkAvailability()
                        InstructorRoomReservation.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        InstructorRoomReservation.reserveRoom("FH102", fh102PurposeText.text)
                        InstructorRoomReservation.checkAvailability()
                        InstructorRoomReservation.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        InstructorRoomReservation.reserveRoom("FH202", fh202PurposeText.text)
                        InstructorRoomReservation.checkAvailability()
                        InstructorRoomReservation.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        InstructorRoomReservation.reserveRoom("FH302", fh302PurposeText.text)
                        InstructorRoomReservation.checkAvailability()
                        InstructorRoomReservation.checkRecent()
                    }
                }
        ...
        Component.onCompleted: {
            InstructorRoomReservation.checkAvailability()
            InstructorRoomReservation.getCurrentAccount()
            InstructorRoomReservation.checkRecent()
        }

        Connections {
            target: InstructorRoomReservation
