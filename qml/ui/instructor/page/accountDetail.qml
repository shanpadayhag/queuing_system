...
Item {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Label {
                    ...
                    Component.onCompleted: accountName.text = InstructorAccountDetails.getName()
                }
                ...
                Label {
                    ...
                    Component.onCompleted: accountID.text = InstructorAccountDetails.getID()
                }
                ...
                Rectangle {
                    ...
                    ScrollView {
                        ...
                        ListView {
                            ...
                            Component.onCompleted: InstructorAccountDetails.displayCoursesFinal()
                        }
                    }
                }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            CustomButton {
                ...
                anchors.topMargin: 10
                onClicked: {
                    if (InstructorAccountDetails.confirm_changes(editNameText.text, editIDText.text, editPasswordText.text, image1.source)) {
                        courseListModelFinal.clear()
                        InstructorAccountDetails.displayCoursesFinal()
                        addAnimationMenu.running = true
                        InstructorAccountDetails.getCurrentAccount()
                        accountName.text = InstructorAccountDetails.getName()
                        accountID.text = InstructorAccountDetails.getID()
        ...
        Rectangle {
            ...
            ScrollView {
                ...
                Component {
                    ...
                    Item {
                        ...
                        MouseArea {
                            ...
                            onDoubleClicked: {
                                InstructorAccountDetails.addToNotHandled(handledCourseCode.text)
                                handledListModel.clear()
                                InstructorAccountDetails.displayHandled()
                                notHandledCourseListModel.clear()
                                InstructorAccountDetails.displayNotHandled()
                            }
                        }
                    }
                }
                ...
                ListView {
                    ...
                    Component.onCompleted: InstructorAccountDetails.displayHandled()
                }
            }
        }
        ...
        Rectangle {
            ...
            ScrollView {
                ...
                Component {
                    ...
                    Item {
                        ...
                        MouseArea {
                            ...
                            onDoubleClicked: {
                                InstructorAccountDetails.addToHandled(notHandledCourseCourseCode.text)
                                notHandledCourseListModel.clear()
                                InstructorAccountDetails.displayNotHandled()
                                handledListModel.clear()
                                InstructorAccountDetails.displayHandled()
                ...
                ListView {
                    ...
                    Component.onCompleted: InstructorAccountDetails.displayNotHandled()
                }
            }
        }
    }
    ...
    Component.onCompleted: {
        InstructorAccountDetails.getCurrentAccount()
        editPasswordText.text = InstructorAccountDetails.getPass()
        image.source = InstructorAccountDetails.getImg()
        image1.source = InstructorAccountDetails.getImg()
    }

    Connections {
        target: InstructorAccountDetails
