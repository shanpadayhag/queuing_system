...
Item {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        StudentReserve.reserveRoom("FH101", fh101PurposeText.text)
                        StudentReserve.checkAvailability()
                        StudentReserve.checkRecent()
                    }
                }
            }
        }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        StudentReserve.reserveRoom("FH201", fh201PurposeText.text)
                        StudentReserve.checkAvailability()
                        StudentReserve.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        StudentReserve.reserveRoom("FH301", fh301PurposeText.text)
                        StudentReserve.checkAvailability()
                        StudentReserve.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        StudentReserve.reserveRoom("FH102", fh102PurposeText.text)
                        StudentReserve.checkAvailability()
                        StudentReserve.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        StudentReserve.reserveRoom("FH202", fh202PurposeText.text)
                        StudentReserve.checkAvailability()
                        StudentReserve.checkRecent()
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    enabled: false
                    onClicked: {
                        StudentReserve.reserveRoom("FH302", fh302PurposeText.text)
                        StudentReserve.checkAvailability()
                        StudentReserve.checkRecent()
                    }
                }
        ...
        Component.onCompleted: {
            StudentReserve.checkAvailability()
            StudentReserve.getCurrentAccount()
            StudentReserve.checkRecent()
        }

        Connections {
            target: StudentReserve
