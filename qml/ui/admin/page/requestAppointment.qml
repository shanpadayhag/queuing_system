...
Item {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                ListView {
                    ...
                    currentIndex: 0
                    Component.onCompleted: AdminRequestAppointment.display()
                }
                clip: true
            }
        }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                CustomButton {
                    ...
                    onClicked: {
                        AdminRequestAppointment.acceptRequest(listModel.get(listView.currentIndex).idAppointment)
                        AdminRequestAppointment.display()
                    }
                }
                ...
                CustomButton {
                    ...
                    anchors.horizontalCenterOffset: 100
                    onClicked: {
                        AdminRequestAppointment.declineRequest(listModel.get(listView.currentIndex).idAppointment)
                        AdminRequestAppointment.display()
                    }
                }
            }
    ...
    Component.onCompleted: AdminRequestAppointment.getCurrentAccount()
    
    Connections {
        target: AdminRequestAppointment
        ...
        function onDisplay_clear_signal() {
            listModel.clear()
            AdminRequestAppointment.display()
        }
    }
